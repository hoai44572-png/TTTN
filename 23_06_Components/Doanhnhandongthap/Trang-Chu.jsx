      ...
      <header className="fixed top-0 left-0 w-full z-50 flex items-center h-[80px] bg-[#2465B3] border-b border-transparent">
        <div className="max-w-[1750px] mx-auto px-4 md:px-[85px] w-full flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center justify-center flex-1 gap-8">
            <a href="/" className="text-[#e5e7eb] text-[15px] font-medium whitespace-nowrap hover:text-white transition-colors">{t.navHome}</a>
            <a href="/QuốcHoài-221A010989/23_06_Components/Doanhnhandongthap/Gioi-Thieu.html" className="text-[#e5e7eb] text-[15px] font-medium whitespace-nowrap hover:text-white transition-colors">{t.navAbout}</a>
            <a href="./Hoi-Vien.html" className="text-[#e5e7eb] text-[15px] font-medium whitespace-nowrap hover:text-white transition-colors">{t.navMembers}</a>
